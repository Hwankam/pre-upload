...
## loss -> in julia, use SDP


hat_Large_sigma_F_NOL
xn
kk <- hat_Large_sigma_F_NOL - Large_sigma
Large_sigma

eigen_5<- eigen(kk)$value
log(sqrt(max(abs(eigen(t(kk) %*% kk)$values))))

log(99999) # almost log number of steps = 11
